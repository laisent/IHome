...
# 创建日志记录器，指明日志保存的路径、每个日志文件的最大大小(100M)、保存的日志文件个数上限(一个文件大小上限后log log1 log2)
...
def create_app(config_name):
    ...
    app.register_blueprint(api_1_0.api, url_prefix="/ihome/api/v1.0")

    # 注册提供静态文件的蓝图
    from ihome import web_html
    app.register_blueprint(web_html.html, url_prefix="/ihome/")
